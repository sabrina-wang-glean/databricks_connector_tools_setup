...
![Databricks connector setup screen in Glean](images/fig1-connector-setup.png)

_Figure 1: Databricks connector setup in Glean, which is separate from the Databricks tools OAuth setup._

![Annotated Databricks connector setup distinguishing the connector from the tools](images/connector-setup-annotated.png)
...
![Healthy Databricks connector with synced items](images/fig2-healthy-connector.png)
...
![Annotated Databricks tools configuration in Glean](images/tools-config-annotated.png)
...
![Databricks Add connection screen](images/databricks-add-connection.png)
...
![Copy the callback URL from Glean into the Databricks App Connection redirect URLs](images/callback-url-annotated.png)

_Copy this callback URL from Glean and paste it into the Databricks App Connection → Redirect URLs._

![Databricks Tools successfully configured in Glean](images/tools-configured.png)
